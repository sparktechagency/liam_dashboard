...
import { SetCategoryCreateError, SetCategoryOptions, SetCategoryUpdateError } from "./materialsSlice";
...
export const materialsApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    getMaterials: builder.query({
      ...
      providesTags: [TagTypes.materials],
    }),
...
export const { useGetMaterialsQuery, useGetCategoryDropDownQuery, useCreateCategoryMutation, useDeleteCategoryMutation, useUpdateCategoryMutation } = materialsApi;
