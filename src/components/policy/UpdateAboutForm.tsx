...
import { useCreateUpdateAboutMutation } from '../../redux/features/policy/policyApi';
...
const UpdateAboutForm = ({description}: TPolicy) => {
    const [content, setContent] = useState(description);
    const [createUpdatePricacy, {isLoading}] = useCreateUpdateAboutMutation()
