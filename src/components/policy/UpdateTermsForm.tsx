...
import { useCreateUpdateTermsMutation } from '../../redux/features/policy/policyApi';
...
const UpdateTermsForm = ({description}: TPolicy) => {
    const [content, setContent] = useState(description);
    const [createUpdateTerms, {isLoading}] = useCreateUpdateTermsMutation()
